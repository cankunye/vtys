      ...
      <div class="container">
        <nav class="nav">
          ...
          <div class="nav__menu">
            ...
            <ul class="nav__list">
              <li class="nav__item">
                <a href="./products.php" class="nav__link scroll-link">Products</a>
              </li>
              <li class="nav__item">
                <a href="#news" class="nav__link scroll-link">Blog</a>
              </li>
              <li class="nav__item">
                <a href="./login.php" class="nav__link scroll-link">Log In</a>
              </li>
            </ul>
          </div>
            ...
            <li class="glide__slide">
              <div class="hero__center">
                <div class="hero__left">
                  <span class="">Yeni Gelen Telefonler</span>
                  <h1 class="">Sizin için özel telefonlar!</h1>
                  <p>Kullancılar tarafından beğenen telefonlar</p>
                  <a href="#"><button class="hero__btn">Şimdi Alın</button></a>
                </div>
